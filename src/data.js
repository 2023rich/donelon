...
import HeroImg from '../src/assets/images/elon1.jpg';
import TitleImg from '../src/assets/img/hero/peperobot.png';
...
export const hero = {
  title: 'PEPE ROBOT',
  titleImg: TitleImg,
  subtitle: <div>Welcome to the world of Don Elon, the ultimate crypto memecoin that pays homage to the Don of Dons, Elon Musk. <b className='text-red-500'>$DONELON</b> is a community driven token that cannot be controlled by anyone.</div>,
  btnText: '14:00 UTC - 5/5/2023',
  image: HeroImg,
};
...
export const pricing = {
  ...
  cards: [
    ...
    },
    {
      ...
      services: [
        { name: 'Launch on PCS' },
        { name: 'Huge marketing campaigns' },
        { name: 'Coingecko listings' },
        { name: 'Coinmarketcap listings' },
    ...
    },
    {
      ...
      title: 'Phase 3',
      services: [
        { name: 'Reach 5000 holders' },
        { name: 'Tier 2 CEX listing' },
        { name: 'To the moon!' },
      ],
      price: '$29.99',
      userAmount: 'up to 3 user + 1.99 per user',
